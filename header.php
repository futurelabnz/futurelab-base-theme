            ...
            <div class="grid-x alignwide">
                ...
                <div class="large-9 medium-12 small-12 align-self-middle align-right">
                    <div class="grid-x grid-padding-x align-right">
                        <nav id="site-navigation" class="main-navigation large-9 medium-12 small-12 flex-child-grow alignright align-self-middle">
                            <div class="small-12 text-center align-middle show-for-small-only">
                                <div class="grid-x">
                                    ...
                                    <div class="small-2 align-middle">
                                        <button id="mobile-menu" class="toggle-menu" aria-controls="mobile-menu" aria-expanded="false" style="border:0;background: none;font-size:24px;padding: 20px 10px;">
                        ...
                        <div class="show-for-large large-2 flex-child-shrink small-margin alignleft">
                            ...
                            if (!empty($button)) : ?>
                                <div class="wp-block-button alignleft">
                                    <a title="<?php echo esc_attr($button); ?>" target="<?php echo esc_attr($button_target); ?>" href="<?php echo $button_url; ?>" class="wp-block-button__link">
                                        <?php echo esc_html($button); ?>
                                    </a>
                                </div>
                            <?php endif; ?>
